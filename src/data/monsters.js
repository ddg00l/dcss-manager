...
export const MONS={
  ...
  orc_priest:{n:'orc priest',t:'m_orc_priest',hp:24,dmg:9,ac:2,ev:8,xp:10,rng:1,mag:1},
  orc_knight:{n:'orc knight',t:'m_orc_knight',hp:48,dmg:20,ac:7,ev:8,xp:20},
  de_mage:{n:'deep elf annihilator',t:'m_de_mage',hp:35,dmg:22,ac:2,ev:12,xp:26,rng:1,mag:1},
  ...
  de_sorcerer:{n:'deep elf sorcerer',t:'m_de_sorcerer',hp:40,dmg:26,ac:3,ev:12,xp:30,rng:1,mag:1},
  de_high_priest:{n:'deep elf high priest',t:'m_de_high_priest',hp:48,dmg:24,ac:4,ev:11,xp:32,rng:1,mag:1},
  ...
  lich:{n:'lich',t:'m_lich',hp:88,dmg:38,ac:10,ev:10,xp:60,mag:1,rng:1,drain:1,und:1},
